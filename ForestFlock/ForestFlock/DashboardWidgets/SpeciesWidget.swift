...
struct SpeciesWidget: View {
    ...
    var body: some View {
        ...
        }.padding(30).frame(width: 250, height: 200).background(LinearGradient(gradient: Gradient(colors: [Color(red: 7/255, green: 217/255, blue: 139/255), Color("dharc-green")]), startPoint: .top, endPoint: .bottom)).cornerRadius(15.0)
    }
}
