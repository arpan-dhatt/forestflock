...
class ViewModel: ObservableObject {
    ...
    @Published var updates: [Update] = [Update.init(device_id: 124, timestamp: "sdfaafdas", sound_class: "gunshot", temperature: nil, humidity: nil, pressure: nil), Update.init(device_id: 125, timestamp: "sdfaafdas", sound_class: "fire", temperature: nil, humidity: nil, pressure: nil), Update.init(device_id: 126, timestamp: "afasfasdfasdfsa", sound_class: nil, temperature: 10.0, humidity: 10.0, pressure: 10.0), Update.init(device_id: 124, timestamp: "afafasdfsa", sound_class: nil, temperature: 10.0, humidity: 10.0, pressure: 10.0)]
