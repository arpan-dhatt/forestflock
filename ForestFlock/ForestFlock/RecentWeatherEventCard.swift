        ...
        if !collapsed{
            ZStack{
                VStack{
                    ...
                    HStack{
                        Button(action: {}){
                            Text("Send Alert").font(.system(size:20)).scaledToFill().padding().overlay(RoundedRectangle(cornerRadius: 10.0).stroke(Color("dharc-green"), lineWidth: 1)).foregroundColor(Color("dharc-green"))
                        }
